...
async function updateGlobeData(data) {
    try {
        ...
        if (dataHandler.geographicLevel === 'regional' && dataHandler.selectedRegion) {
            ...
            // Se non c'è nessun livello valido, svuota i punti
            globe.addCovidPoints([], 'national');
        }
    } catch (error) {
